...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="card-elevated overflow-hidden">
            ...
            <h1 class="text-3xl font-bold text-thistle mb-4">{{ $articulo->nombre }}</h1>

            @if($articulo->descripción)
                <div class="prose max-w-none mb-6">
                    <p class="text-charcoal/80 whitespace-pre-line leading-relaxed">{{ $articulo->descripción }}</p>
                </div>
            @endif

            <div class="flex items-center gap-4 text-sm text-thistle/60 mb-6">
