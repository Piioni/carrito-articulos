            ...
            @foreach ($sugerencias as $sugerencia)
                <a href="{{ route('sugerencias.show', $sugerencia) }}" class="group">
                    <div class="card-hover flex h-full flex-col">
                        <h3 class="text-thistle group-hover:text-fulvous mb-3 text-lg font-bold transition-colors">
                            {{ $sugerencia->titulo }}
                        </h3>

                        <p class="text-charcoal/70 mb-4 line-clamp-3 flex-1 text-sm">
                        ...
                        <div class="border-accent/20 flex items-center justify-between border-t pt-4">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-thistle text-sm font-medium">
                                    {{ $sugerencia->user->name }}
                                </span>
                            </div>
                            <span class="text-thistle/60 text-xs">
