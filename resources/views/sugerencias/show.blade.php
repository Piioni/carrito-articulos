...
@section('content')
    <div class="mx-auto max-w-4xl">
        ...
        <div class="card-elevated">
            <h1 class="text-thistle mb-6 text-3xl font-bold">{{ $sugerencia->titulo }}</h1>

            {{-- Author info --}}
            <div class="border-accent/20 mb-6 flex items-center gap-4 border-b pb-6">
                <a
                ...
                >
                    ...
                    <div>
                        <span class="text-thistle block font-semibold">{{ $sugerencia->user->name }}</span>
                        <span class="text-thistle/60 text-sm">{{ $sugerencia->created_at->format('d M, Y') }}</span>
                    </div>
                </a>
            </div>
            ...
            <div class="prose mb-6 max-w-none">
                <p class="text-charcoal/80 whitespace-pre-line text-lg leading-relaxed">{{ $sugerencia->texto }}</p>
            </div>
