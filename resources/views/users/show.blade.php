...
@section('content')
    <div class="mx-auto max-w-3xl">
        ...
        <div class="card-elevated mb-6">
            <div class="flex items-center gap-4">
                ...
                <div class="min-w-0 flex-1">
                    <h1 class="text-thistle truncate text-xl font-bold">{{ $user->name }}</h1>
                    <p class="text-charcoal/70 truncate text-sm">{{ $user->email }}</p>
                    <p class="text-thistle/50 mt-0.5 text-xs">
        ...
        <div class="mb-4 flex items-center justify-between">
            <h2 class="text-thistle text-lg font-bold">
                Sugerencias
                        ...
                        <div class="card-hover">
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0">
                                    ...
                                    <p class="text-charcoal/60 line-clamp-1 text-sm">
                                        {{ $sugerencia->texto }}
                                    </p>
                                </div>
                                <span class="text-thistle/50 shrink-0 text-xs">
