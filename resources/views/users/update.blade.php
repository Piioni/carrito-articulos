...
@section('content')
    <div class="mx-auto max-w-2xl">
        ...
        <div class="mb-6 text-center">
            ...
            <h1 class="text-thistle text-2xl font-bold">Editar Perfil</h1>
            <p class="text-thistle/60 mt-1 text-sm">Actualiza tu información personal</p>
        </div>

        <x-ui.card variant="elevated">
            <x-form.form :action="route('users.update', $user)" method="PUT" buttonText="Guardar Cambios">
                <x-form.input name="name" label="Nombre completo" :value="$user->name" required />

                <x-form.input name="email" label="Correo Electrónico" type="email" :value="$user->email" required />

                <div class="divider"></div>

                <p class="text-thistle/70 mb-3 flex items-center gap-1.5 text-sm">
                ...
                <x-form.input name="password" label="Nueva Contraseña" type="password" placeholder="••••••••" />
